...
<body>
	<div class="men_banner">
		...
		<div class="container">
			...
			<h4><b>Segurança</b></h4>
			<p>
				Fique tranqüilo! Você está em um ambiente seguro!<br><br>
				
				Na Fiuzalizz, todas as operações são criptografadas e 100% processadas por computador, sem intervenção humana.<br><br>
				
				Todas as informações que passam pelo nosso processo de compra online são codificadas, desde seus dados pessoais até a forma de pagamento. Verifique o ícone "cadeado fechado" na parte inferior do seu monitor durante o seu pedido de compra na Fiuzalizz. Esta segurança é certificada pela GeoTrust, uma empresa Verisign, a maior autoridade em proteção do consumidor e segurança online em todo o mundo.<br><br>
				
				Na Fiuzalizz, o número do seu cartão de crédito é usado somente no processamento de compra, não sendo, de nenhuma forma, guardado nos arquivos depois da operação.<br><br>
				Boas compras!
			</p>
		</div>
		<div class="footer">
