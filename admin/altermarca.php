...
$query = mysqli_query($con,"SELECT * FROM marca WHERE Nome = '".$_GET['id']."'");
...
<body>	
	...
	<div class="container">
		<div class="row">
			<h4 class="text-center">Alterar Marca</h4>
		</div>

		<div class="row">
			<a href="marca.php"><button type="button" class="btn btn-danger pull-right"><i class="fa fa-undo" aria-hidden="true"></i></button></a>
		</div>
		<form accept-charset="utf-8" action="alter.php" enctype="multipart/form-data"  method="POST">
			...
			<input type="text" id="tipo" name="id" value="<?php echo $nome ?>">
