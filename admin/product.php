		...
		<table class="table table-hover">
			...
			while ($row = mysqli_fetch_array($query)) {
				...
				<tr>
					...
					<td><a href="alterproduct.php?id='.$id.'"><button class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></button></a></td>			
				</tr>
			';
		}
		?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title custom_align" id="Heading">Delete este produto</h4>
			</div>
			...
			<div class="modal-footer ">
				<form accept-charset="utf-8" action="delete.php" method="POST">
					...
					<button id="whoDel" name="produto" type="submit" value="" class="btn btn-danger" ><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
