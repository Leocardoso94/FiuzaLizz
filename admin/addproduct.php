	...
	<div class="container">
		...
		<form accept-charset="utf-8" action="insert.php" enctype="multipart/form-data"  method="POST">
			...
			<div class="form-group">
				...
				<textarea type="textAREA" maxlength="" class="form-control" id="descr" name="descr" placeholder="Descriçao" required textarea></textarea>
			</div>
			...
			<div class="form-group">
				...
				<select  class="form-control" name="marca" class="selectpicker" id="marca" required>
					<?php 
			...
			<div class="form-group">
				...
				<select  class="form-control" id="cat" name="cat" class="selectpicker" required>
					<?php 
			...
			<div class="form-group">
				...
				<input type="number" class="form-control" name="vendas" id="vendas" placeholder="Vendas" required>
			</div>

			<div class="form-group">
				<label for="peso">Peso</label>
				<input type="number" class="form-control" name="peso" id="peso" placeholder="Peso" step="0.01" required>
			</div>
