				...
				<tr>
					...
					<td>
						<p data-placement="top" data-toggle="tooltip" title="Delete">
							...
							<button class="del btn btn-danger btn-xs '.$id.'" data-title="Delete" data-toggle="modal" data-target="#delete" ><i class="fa fa-trash-o" aria-hidden="true"></i></span>
							</button>

						</p>
					</td>
					<td><a href="altercliente.php?id='.$id.'"><button class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></button></a></td>			
				</tr>
			';
		}
		?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title custom_align" id="Heading">Deletar este Cliente?</h4>
			</div>
			...
			<div class="modal-footer ">
				<form accept-charset="utf-8" action="delete.php" method="POST">
					...
					<button id="whoDel" name="produto" type="submit" value="" class="btn btn-danger" ><span class="glyphicon glyphicon-ok-sign"></span> Sim</button>
