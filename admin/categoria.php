...
<body>	
	...
	<div class="container">
		...
		<div class="row">
			<a href="addcategoria.php"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus" aria-hidden="true"></i></button></a>
		</div>
		<table class="table table-hover">
			...
			while ($row = mysqli_fetch_array($query)) {
				...
				<tr>
					...
					<td><a href="altercategoria.php?id='.$nome.'"><button class="btn btn-info"><i class="fa fa-pencil" aria-hidden="true"></i></button></a></td>			
				</tr>
				';
			}
			?>
			...
			<div class="modal-content">
				...
				<div class="modal-footer ">
					<form accept-charset="utf-8" action="delete.php" method="POST">
						<input type="text" id="tipo" name="tipo" value="categoria">
						<button id="whoDel" name="categoria" type="submit" value="" class="btn btn-danger" ><span class="glyphicon glyphicon-ok-sign"></span> Yes</button>
