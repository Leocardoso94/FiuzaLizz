...
$query = mysqli_query($con,"SELECT * FROM categoria WHERE NomeCategoria = '".$_GET['id']."'");
...
<body>	
	...
	<div class="container">
		<div class="row">
			<h4 class="text-center">Alterar Categoria</h4>
		</div>

		<div class="row">
			<a href="categoria.php"><button type="button" class="btn btn-danger pull-right"><i class="fa fa-undo" aria-hidden="true"></i></button></a>
		</div>
